        ...
        <div id="Content">
            ...
            <div class="errors">
                ...
                <p style="width:80%">
                    ...
                    Sequence datafile (<a href="${createLinkTo(dir:'files',file:'sample.tnt')}" target="_blank">sample</a>)
                    - a file containing phylogenetic data, such as DNA sequences in TNT format.<br/><br/>
                    Geographic datafile (<a href="${createLinkTo(dir:'files',file:'sample.csv')}" target="_blank">sample</a>)
